...
bool JuliaQuintic::MultiThreadRender(bool preview, bool super_sample)
{
...
{
	return L"Julia (z^5): " + std::to_wstring(Var.a) + L" + " + std::to_wstring(Var.b) + L"i; " + std::to_wstring(xmin) + L", " + std::to_wstring(xmax) + L" / " + std::to_wstring(ymin) + L", " + std::to_wstring(ymax);
}
